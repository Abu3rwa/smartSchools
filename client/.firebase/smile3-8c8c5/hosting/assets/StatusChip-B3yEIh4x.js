import{b as v,j as b}from"./vendor-charts-aYP_PeIk.js";import{g as w,d as k,u as S,j as c,a as R,s as x,m as E,a4 as h,a3 as m}from"./index-1_6cEl8e.js";import{C as U}from"./Chip-CxnrS9l-.js";function $(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return w("MuiSkeleton",t)}k("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const D=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return R({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},A,e)},r=m`
  0% {
    opacity: 1;
  }
