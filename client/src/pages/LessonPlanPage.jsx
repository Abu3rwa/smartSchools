...
const DEFAULT_STAGES = [
  ...
  {
    name: "Homework/Take Home Material",
    procedure: "",
    materials: "",
    timing: "",
  },
...
const LessonPlanPage = () => {
  ...
  const handleGenerateFromTitle = async () => {
    ...
    if (generateSection.fulfilled.match(result)) {
      ...
      setFormData((prev) => ({
        ...
        teachingObjectives:
          prev.teachingObjectives || g.teachingObjectives || "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingId) {
      const result = await dispatch(
        updateLesson({ id: editingId, lessonData: payload }),
      );
          ...
          <div className="lessons-grid">
            {lessons.map((lesson) => (
              <div key={lesson._id} className="card lesson-card">
                ...
                {Array.isArray(lesson.standardIds) &&
                  lesson.standardIds.length > 0 && (
              ...
              <div className="modal-body lesson-plan-form">
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <AISuggestButton
                    ...
                    onSuggestion={(s) =>
                      setFormData({ ...formData, summary: s })
                    }
                  />
                </div>
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <AISuggestButton
                    ...
                    summary={formData.summary}
                    onSuggestion={(s) =>
                      setFormData({ ...formData, description: s })
                    }
                  />
                </div>
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <AISuggestButton
                    ...
                    summary={formData.summary}
                    onSuggestion={(s) =>
                      setFormData({ ...formData, homework: s })
                    }
                  />
                </div>
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        teachingObjectives: e.target.value,
                      })
                    }
                  />
                ...
                <StandardsSuggester
                  ...
                  onSelectionChange={(ids) =>
                    setFormData({ ...formData, standardIds: ids })
                  }
                />
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <AISuggestButton
                    ...
                    title={formData.title}
                    onSuggestion={(s) =>
                      setFormData({ ...formData, vocabulary: s })
                    }
                  />
                </div>
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        characterTraitLinks: e.target.value,
                      })
                    }
                  />
                ...
                <div className="form-group form-group-with-suggest">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        techIntegration: e.target.value,
                      })
                    }
                  />
                    ...
                    <div key={index} className="stage-block">
                      ...
                      <div className="form-group form-group-with-suggest">
                        ...
                        <AISuggestButton
                          ...
                          summary={formData.summary}
                          onSuggestion={(s) =>
                            handleStageChange(index, "procedure", s)
                          }
                        />
                      </div>
                      <div className="form-group">
