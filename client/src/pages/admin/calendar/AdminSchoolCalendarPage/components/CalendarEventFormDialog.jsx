...
import { toAudienceOption } from '../utils/calendarPresentation';
        ...
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            ...
            <DialogContent>
                <Stack spacing={1.5} sx={{ mt: 0.5 }}>
                    ...
                    >
                        {CALENDAR_FILTER_OPTIONS.filter((item) => item.value !== 'ALL').map((item) => (
                        ...
                        <Stack spacing={1.25}>
                            ...
                            {formState.recurrenceFrequency === 'WEEKLY' && (
                                <Stack direction="row" spacing={0.8} useFlexGap flexWrap="wrap">
                                    {CALENDAR_RECURRENCE_WEEKDAY_OPTIONS.map((item) => {
