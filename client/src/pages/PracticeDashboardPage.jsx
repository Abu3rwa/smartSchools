...
import {
    HiOutlineAcademicCap, HiOutlinePlay, HiOutlineEye,
    HiOutlineBookOpen, HiOutlineCheckCircle
} from 'react-icons/hi';
...
const PracticeDashboardPage = () => {
    ...
    const inProgress = assignments.filter(a => !a.mastery?.isMastered && a.mastery?.totalAttempts > 0);
    const notStarted = assignments.filter(a => !a.mastery?.isMastered && a.mastery?.totalAttempts === 0);
        ...
        <div className="practice-dashboard">
            <div className="page-header">
                <div>
                    ...
                    <p className="text-muted">Practice and master your assigned standards with AI-generated questions</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="practice-standards-list">
                    {assignments.map(a => (
                        <div key={a._id} className={`practice-card ${a.mastery?.isMastered ? 'mastered' : ''}`}>
                            {a.mastery?.isMastered && <div className="mastered-overlay">Mastered</div>}
                            <div className="practice-card-top">
                                ...
                                <span className="mastery-badge" style={{
                                    ...
                                    {a.mastery?.isMastered ? 'Mastered' : a.mastery?.totalAttempts > 0 ? 'In Progress' : 'Not Started'}
                                </span>
                            </div>
                            ...
                            <div className="practice-card-meta">
                                ...
                                <span><HiOutlineAcademicCap size={14} /> Grade {a.standard?.gradeLevel}</span>
                            </div>
                            <div className="practice-progress">
                                ...
                                <div className="practice-progress-text">
                                    <span>{a.mastery?.correctCount || 0}/{a.mastery?.totalAttempts || 0} correct</span>
                            ...
                            <div className="practice-card-actions">
                                {a.mastery?.isMastered ? (
                                    <button
                                        ...
                                        onClick={() => navigate(`/portal/practice/${a._id}/history`)}
                                    >
                                        <HiOutlineCheckCircle size={16} style={{ marginRight: 4 }} />
                                        View History
                                    </button>
                                ) : (
                                    <>
