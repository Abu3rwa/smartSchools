...
export const featureMetaMap = {
    gradebook: { audience: 'For teachers', highlight: 'Faster grading cycles', tint: 'rgba(13,148,136,0.22)' },
    ...
    security: { audience: 'For admins', highlight: 'Safer school data', tint: 'rgba(13,148,136,0.2)' },
    mobile: { audience: 'For everyone', highlight: 'Work from anywhere', tint: 'rgba(15,23,42,0.2)' },
    ...
    governance: { audience: 'For platform', highlight: 'Secure oversight', tint: 'rgba(13,148,136,0.18)' },
};
