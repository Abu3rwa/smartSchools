        ...
        try {
            ...
            const parsed = lines.map(line => {
                ...
                return {
                    ...
                    gradeLevel: parts[3] ? parseInt(parts[3].trim()) : parseInt(filterGrade) || 1,
                ...
                <div className="import-section">
                    ...
                    <div className="form-group">
                        ...
                        <p className="import-help">
                            Each line: Code, Name, Description, Grade Level (number), Category (optional).
                            Separate with tabs or commas. Grade defaults to filter selection if omitted.
                        </p>
                    </div>
                    <button
