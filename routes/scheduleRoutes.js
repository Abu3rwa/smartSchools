...
router.post('/', authorize('admin', 'school_admin', 'teacher'), createSchedule);
...
// @access  Private (School Admin, Teacher)
router.put('/:id', authorize('admin', 'school_admin', 'teacher'), updateSchedule);

// @route   DELETE /api/schedules/:id
// @desc    Delete schedule
// @access  Private (School Admin, Teacher)
router.delete('/:id', authorize('admin', 'school_admin', 'teacher'), deleteSchedule);

// @route   POST /api/schedules/:id/cancel
// @desc    Cancel schedule
// @access  Private (School Admin, Teacher)
router.post('/:id/cancel', authorize('admin', 'school_admin', 'teacher'), cancelSchedule);
...
router.post('/:id/attendance', authorize('admin', 'school_admin', 'teacher'), recordAttendance);

// @route   POST /api/schedules/:id/participants
// @desc    Add participant to schedule
// @access  Private (School Admin, Teacher)
router.post('/:id/participants', authorize('admin', 'school_admin', 'teacher'), addParticipant);

// @route   DELETE /api/schedules/:id/participants/:userId
// @desc    Remove participant from schedule
// @access  Private (School Admin, Teacher)
router.delete('/:id/participants/:userId', authorize('admin', 'school_admin', 'teacher'), removeParticipant);
